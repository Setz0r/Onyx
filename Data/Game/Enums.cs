...
namespace Data.Game
{
    ...
    public enum ENTITYSTATUS : byte
    {
        ...
        MOB              = 0x01,
        DISAPPEAR        = 0x02,
        INVISIBLE        = MOB | DISAPPEAR,
        STATUS_04        = 0x04,
        CUTSCENE_ONLY    = DISAPPEAR | STATUS_04,
        STATUS_08        = 0x08,
        STATUS_10        = 0x10,
        STATUS_12        = DISAPPEAR | STATUS_10,
    ...
    {
        ERR,
        AMORPH, AQUAN, ARCANA, ARCHAICMACHINE,
        AVATAR, BEAST, BEASTMEN, BIRD,
        DEMON, DRAGON, ELEMENTAL, EMPTY,
        HUMANOID, LIZARD, LUMORIAN, PLANTOID,
