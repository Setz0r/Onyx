...
public struct FBPlayer : IFlatbufferObject
{
  ...
  public static Offset<Data.FBEntities.FBPlayer> CreateFBPlayer(FlatBufferBuilder builder,
    ...
    FBPlayer.AddBase(builder, baseOffset);
    FBPlayer.AddMaxmp(builder, maxmp);
    FBPlayer.AddMp(builder, mp);
    FBPlayer.AddMaxhp(builder, maxhp);
    FBPlayer.AddHp(builder, hp);
    return FBPlayer.EndFBPlayer(builder);
  }

  public static void StartFBPlayer(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<Data.FBEntities.FBPlayer> EndFBPlayer(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Data.FBEntities.FBPlayer>(o);
  }
  public static void FinishFBPlayerBuffer(FlatBufferBuilder builder, Offset<Data.FBEntities.FBPlayer> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedFBPlayerBuffer(FlatBufferBuilder builder, Offset<Data.FBEntities.FBPlayer> offset) { builder.FinishSizePrefixed(offset.Value); }
};
